...
/* 4 : /soc/peripheral@50000000/usbd@36000/cdc_acm_uart1:
 * Direct Dependencies:
 *   - (/soc/peripheral@50000000/usbd@36000)
 */
const device_handle_t __aligned(2) __attribute__((__section__(".__device_handles_pass2")))
__devicehdl_DT_N_S_soc_S_peripheral_50000000_S_usbd_36000_S_cdc_acm_uart1[] = { DEVICE_HANDLE_SEP, DEVICE_HANDLE_SEP, DEVICE_HANDLE_ENDS };

/* 5 : /soc/peripheral@50000000/usbd@36000/cdc_acm_uart0:
 * Direct Dependencies:
 *   - (/soc/peripheral@50000000/usbd@36000)
 */
const device_handle_t __aligned(2) __attribute__((__section__(".__device_handles_pass2")))
...
/* 6 : /soc/peripheral@50000000/uart@8000:
 * Direct Dependencies:
 *   - (/soc/interrupt-controller@e000e100)
 *   - (/soc/peripheral@50000000)
 */
